...
export default function LandingPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center bg-gradient-to-b from-[#020d08] via-[#031c12] to-[#010805] text-white overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className={`mt-12 ${entered ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'} transition-all duration-1000 delay-350`}>
          <Link href="/app" className="inline-block rounded-full bg-gradient-to-r from-emerald-400 to-teal-300 px-10 py-4 text-lg font-semibold text-black shadow-2xl shadow-emerald-500/30 hover:scale-[1.02] transition-transform">
            Go to App
          </Link>
        </div>
      </div>
